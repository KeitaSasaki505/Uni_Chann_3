...
ActiveRecord::Schema.define(version: 2020_10_29_134743) do
  ...
  create_table "joins", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["event_id_id"], name: "index_joins_on_event_id_id"
    t.index ["user_id_id"], name: "index_joins_on_user_id_id"
  end
